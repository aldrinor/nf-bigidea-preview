...
Z = 14
# bbox covering Mount Victoria (51.3833,-116.2833) + Lake Louise (51.4175,-116.2181)
W, E, S, N = -116.36, -116.14, 51.34, 51.46
...
np.save("banff_dem.npy", out)
with open("dem_meta.txt", "w") as f:
    f.write(f"Z={Z}\nbbox_WESN={W},{E},{S},{N}\ntiles={nx}x{ny}\nshape={out.shape}\n")
v = out[np.isfinite(out)]
print(f"elevation  min {v.min():.0f} m   max {v.max():.0f} m   mean {v.mean():.0f} m")
print("REALITY CHECK -> Mount Victoria summit is 3464 m; Lake Louise sits at 1750 m")
