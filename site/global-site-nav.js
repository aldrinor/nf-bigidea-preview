(function () {
  ...
  var cursorSource = navScript && navScript.src
    ? new URL("positive-charge-cursor.js?v=20260818-05", navScript.src).href
    : "/positive-charge-cursor.js?v=20260818-05";
  ...
  document.body.insertAdjacentHTML("afterbegin", `
    <div class="cp-global-nav" role="banner">
      ...
      <nav class="cp-global-nav__links" aria-label="Site navigation">
        ...
        <div class="cp-global-nav__item" data-cp-global-dropdown="cp-global-science-menu">
          <a class="cp-global-nav__trigger" href="/science/" aria-expanded="false" aria-controls="cp-global-science-menu"${current("science")}>Science &amp; Evidence</a>
        </div>
    ...
    <nav id="cp-global-applications-menu" class="cp-global-dropdown cp-global-dropdown--applications" hidden aria-label="Applications menu">
      <a class="cp-global-dropdown__row" href="/air/"><span class="cp-global-dropdown__index">01</span><span>Air Filtration</span><span class="cp-global-dropdown__arrow" aria-hidden="true">↗</span></a>
      <a class="cp-global-dropdown__row" href="/development/"><span class="cp-global-dropdown__index">02</span><span>R&amp;D / Development</span><span class="cp-global-dropdown__arrow" aria-hidden="true">↗</span></a>
    </nav>

    <nav id="cp-global-science-menu" class="cp-global-dropdown cp-global-dropdown--science" hidden aria-label="Science and Evidence menu">
      <a class="cp-global-dropdown__row" href="/how-it-works/"><span class="cp-global-dropdown__index">01</span><span>How It Works</span><span class="cp-global-dropdown__arrow" aria-hidden="true">↗</span></a>
      <div class="cp-global-dropdown__parent"><span class="cp-global-dropdown__index">02</span><span>Explore by Pollutant</span></div>
      <div class="cp-global-dropdown__children">
        <a class="cp-global-dropdown__child" href="/pollutants/ultrafine-particles/"${pollutantCurrent("ultrafine")}><span class="cp-global-dropdown__letter">A.</span><span>Ultrafine Particles</span></a>
        <a class="cp-global-dropdown__child" href="/pollutants/wildfire-smoke/"${pollutantCurrent("wildfire")}><span class="cp-global-dropdown__letter">B.</span><span>Wildfire Smoke</span></a>
        <a class="cp-global-dropdown__child" href="/pollutants/viruses/"${pollutantCurrent("virus")}><span class="cp-global-dropdown__letter">C.</span><span>Viruses</span></a>
        <a class="cp-global-dropdown__child" href="/pollutants/bacteria/"${pollutantCurrent("bacteria")}><span class="cp-global-dropdown__letter">D.</span><span>Bacteria</span></a>
        <a class="cp-global-dropdown__child" href="/pollutants/mold/"${pollutantCurrent("fungi")}><span class="cp-global-dropdown__letter">E.</span><span>Mold &amp; Fungal Spores</span></a>
      </div>
      <a class="cp-global-dropdown__row cp-global-dropdown__row--evidence" href="/science/"><span class="cp-global-dropdown__index">03</span><span>Evidence</span><span class="cp-global-dropdown__arrow" aria-hidden="true">↗</span></a>
    </nav>
    ...
    <nav id="cp-global-mobile-menu" class="cp-global-mobile" hidden aria-label="Mobile navigation">
      ...
      <button class="cp-global-mobile__toggle" type="button" aria-expanded="false" aria-controls="cp-global-mobile-applications"><span>01</span>Applications</button>
      <div id="cp-global-mobile-applications" class="cp-global-mobile__submenu" hidden>
        <a href="/air/"><span>01</span>Air Filtration</a>
        <a href="/development/"><span>02</span>R&amp;D / Development</a>
      </div>
      <button class="cp-global-mobile__toggle" type="button" aria-expanded="false" aria-controls="cp-global-mobile-science"><span>02</span>Science &amp; Evidence</button>
      <div id="cp-global-mobile-science" class="cp-global-mobile__submenu" hidden>
        <a href="/how-it-works/"><span>01</span>How It Works</a>
        <p class="cp-global-mobile__label">02 &nbsp; Explore by Pollutant</p>
        <div class="cp-global-mobile__children">
          <a href="/pollutants/ultrafine-particles/"><span>A.</span>Ultrafine Particles</a>
          <a href="/pollutants/wildfire-smoke/"><span>B.</span>Wildfire Smoke</a>
          <a href="/pollutants/viruses/"><span>C.</span>Viruses</a>
          <a href="/pollutants/bacteria/"><span>D.</span>Bacteria</a>
          <a href="/pollutants/mold/"><span>E.</span>Mold &amp; Fungal Spores</a>
        </div>
        <a href="/science/"><span>03</span>Evidence</a>
      </div>
      <a href="/company/"><span>03</span>Company</a>
      <a href="/contact/"${current("contact")}><span>04</span>Contact C-POLAR</a>
    </nav>
  `);
