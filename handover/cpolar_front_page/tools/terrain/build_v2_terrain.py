# -*- coding: utf-8 -*-
"""Build the standalone terrain mesh for the v2 hero - assets/banff_terrain.glb.
...
OUT = r"C:\EPA\US\website_project\_cpolar_v2\assets\banff_terrain.glb"
...
# Was 0.55 of the sampling interval. Anti-aliasing is right in principle and it was
# taking the ridges off with it - at GRID 420 the field is barely being downsampled at
# all, so a much lighter touch is enough.
s = ndimage.gaussian_filter(s, (s.shape[0] / GRID) * 0.22)
